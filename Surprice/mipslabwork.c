...
volatile int* portE = (volatile int*) 0xbf8810a0; // initierar pekare portE
...
void labinit( void )
{
    ...
    *portE = 0; // Sätter portE till 0
    ...
    IEC(0) = 0x80; // Sätter bit 7 till 1 för att enabla INT1
    IPC(2) = 0x1C; // Bit 2:4 ska sättas till 1.
    IPC(1) = 0x1c000000; //Bit 28-26 ska sättas till 1.
    enable_interrupts();
}
